...
# -if the study is underpowered => conclusions from the BF are largely unreliable (inconsistent across iterations)
# -If the study has enough power => the conclusions from the BF are reliable (consistent across iterations),
