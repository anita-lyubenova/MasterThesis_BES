...
cond<-expand.grid(r2,pcor,p, ratio_beta, n,studies,iter) %>% 
  rename(r2=Var1, pcor=Var2, p=Var3, ratio_beta=Var4,n=Var5, study=Var6, iter=Var7) %>% 
...
res3par<-parLapply(cl,
  ...
  listel<-single_sim_ln(r2=cond[i,]$r2,  # R-squared of the regression model
