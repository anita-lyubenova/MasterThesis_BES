...
#Load files 
filenames<-list.files("Part I/data simulation/output_lognorm", pattern = ".rds")
path<-"Part I/data simulation/output_lognorm"
...
saveRDS(BF_bind2, "Part I/pre-processing/output/BF_data_lognorm.rds")
